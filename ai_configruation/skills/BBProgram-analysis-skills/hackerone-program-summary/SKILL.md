# HackerOne Program Summary Skill

## Purpose

When the user provides a HackerOne program URL, extract the program’s important information and create a concise Markdown summary file.

## Input

A HackerOne program URL such as:

`https://hackerone.com/<program-name>`

## Output

Create a single Markdown file that includes:
...
* Any important exceptions or prohibitions
...
* If the URL belongs to a HackerOne program, summarize that program only.
