---
name: hunt-graphql
description: GraphQL security testing: introspection, auth bypass, batching attacks, field-level auth, nested query DoS.
---
...
# Additional Techniques (merged from offensive-graphql/SKILL.md)
