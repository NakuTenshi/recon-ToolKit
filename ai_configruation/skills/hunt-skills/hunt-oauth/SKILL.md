---
name: hunt-oauth
description: OAuth/OIDC security testing: redirect_uri manipulation, token theft, PKCE bypass, state parameter bypass, implicit flow abuse.
---
...
# Additional Techniques (merged from auth/offensive-oauth/SKILL.md)
