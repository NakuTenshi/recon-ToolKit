...
description: File upload security testing: bypass techniques, web shells, SVG XSS, path traversal, magic bytes spoofing.
---
...
# Additional Techniques (merged from hunt-file-upload/SKILL.md)
