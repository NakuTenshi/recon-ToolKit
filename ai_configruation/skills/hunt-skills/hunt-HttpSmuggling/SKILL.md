---
name: http-smuggling-testing
description: HTTP request smuggling: CL.TE, TE.CL, H2.CL, TE obfuscation, multi-layer proxy chains, connection pooling attacks.
---
...
# Additional Techniques (merged from hunt-http-smuggling/SKILL.md)
