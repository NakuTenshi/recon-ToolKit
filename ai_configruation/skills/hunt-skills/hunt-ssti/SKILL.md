---
name: ssti-testing
description: Server-Side Template Injection: detection payloads, polyglots, RCE chains for Jinja2/Twig/Freemarker/ERB. Filter bypass and impact escalation.
---
...
# Additional Techniques (merged from hunt-ssti/SKILL.md)
